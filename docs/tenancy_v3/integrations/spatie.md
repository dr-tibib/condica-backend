...
Next, add the following listeners to the TenancyBootstrapped and TenancyEnded events to events() in your TenancyServiceProvider. Or create a custom bootstrapper.
...
Then, change the url_generator in the media-library config to the custom one.
