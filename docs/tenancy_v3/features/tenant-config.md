...
This feature maps keys in the tenant storage (properties on the Tenant model, these may be [custom columns](https://tenancyforlaravel.com/docs/v3/tenants#custom-columns) or virtual columns within data) to config keys based on the $storageToConfigMap static property.
